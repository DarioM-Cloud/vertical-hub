...
import { User, MapPin, Activity, Award, Calendar, Share2, TrendingUp, Lock, Globe, Hash } from 'lucide-react';
import Container from '@/components/_base/layout/container';
import Button from '@/components/_base/ui/button';
import styles from '../perfil.module.scss';

export default function GuestProfileView({ profile, logbook = [], posts = [] }) {
    ...
    <Container className={styles.container}>
      ...
      {isPrivate ? (
        <div className={styles.emptyState} style={{ marginTop: '40px' }}>
          ...
          <p>Este perfil es privado. Inicia sesión para interactuar con esta cuenta.</p>
        </div>
      ) : (
        <>
